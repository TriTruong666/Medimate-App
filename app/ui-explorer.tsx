...
const routes = [
    ...
    { name: "Prescription - Add", path: "/(manager)/(prescription)/add" },
    { name: "Prescription - Detail", path: "/(manager)/(prescription)/[id]" },
    { name: "Prescription - Edit", path: "/(manager)/(prescription)/edit" },
    { name: "Prescription - List", path: "/(manager)/(prescription)/list" },
];
