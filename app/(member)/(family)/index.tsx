...
export default function MemberFamilyListScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white" edges={["top"]}>
      <ManagerHeader subtitle="Gia đình" />
      ...
      >
        <View className="mb-8">
          ...
          <Text className="text-[17px] text-gray-500 mt-2 font-space-medium leading-relaxed">
            Xem thông tin các nhóm gia đình bạn đang tham gia.
          </Text>
        </View>
          ...
          <View className="gap-y-5">
            {filteredFamilies.map((family) => (
              <Pressable
                ...
                onPress={() =>
                  router.push({
                    pathname: "/(member)/(family)/family-members",
