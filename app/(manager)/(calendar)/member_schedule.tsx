...
import {
  useGetMemberDailyReminders,
  useGetMemberSchedules,
...
export default function MemberScheduleScreen() {
  ...
  return (
    <SafeAreaView
      style={{ flex: 1, backgroundColor: "#F9F6FC" }}
      edges={["top"]}
    >
      {/* Header */}
      <View
      ...
      >
        ...
        >
          <Pressable
            ...
            style={{
              ...
              alignItems: "center",
              gap: 6,
              backgroundColor: viewMode === "7days" ? "#000" : "transparent",
            }}
          >
            <StretchHorizontal
              size={16}
              color={viewMode === "7days" ? "#FFF" : "#000"}
            />
            {viewMode === "7days" && (
              <Text
                style={{
          ...
          <Pressable
            ...
            style={{
              ...
              alignItems: "center",
              gap: 6,
              backgroundColor: viewMode === "30days" ? "#000" : "transparent",
            }}
          >
            <LayoutGrid
              size={16}
              color={viewMode === "30days" ? "#FFF" : "#000"}
            />
            {viewMode === "30days" && (
              <Text
                style={{
        ...
        <View style={{ zIndex: 200, flexDirection: "row", gap: 10 }}>
          ...
          <Pressable
            onPress={() =>
              router.push({
                pathname: "/(manager)/(prescription)/member_prescriptions",
          ...
          <Pressable
            ...
            style={{
              width: 44,
              height: 44,
              backgroundColor: showAddMenu ? "#FCA5A5" : MINT_GREEN,
              borderWidth: 2,
              borderColor: BORDER_COLOR,
              borderRadius: 14,
              alignItems: "center",
              ...
              {[
                {
                  ...
                  bg: "#DBEAFE",
                  path: "/(manager)/(prescription)/scan_prescription",
                },
                {
                  label: "Upload đơn",
                  icon: <FileUp size={16} color="#000" />,
                  bg: "#FEF3C7",
                  path: "/(manager)/(prescription)/upload_prescription",
                },
                {
                  label: "Thủ công",
                  icon: <FileText size={16} color="#000" />,
                  bg: "#F3E8FF",
                  path: "/(manager)/(prescription)/add_manual_prescription",
                },
                {
                  label: "Đơn ngoài",
                  icon: <FileText size={16} color="#FACC15" />,
                  bg: "#FEF9C3",
                  path: "/(manager)/(prescription)/add_empty_prescription",
                },
              ].map((item, idx) => (
                  ...
                  >
                    ...
                    <View
                      style={{
                        ...
                        justifyContent: "center",
                        backgroundColor:
                          isToday && !isSelected ? "#FEF9C3" : "transparent",
                      }}
                    >
                      <Text
                        style={{
            ...
            >
              ...
              <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
                {monthDays.map((day, idx) => {
                  ...
                  const isSelected =
                    day.format("YYYY-MM-DD") === selectedDateStr;
                  const isToday = day.isSame(dayjs(), "day");
              ...
              >
                <Pressable
                  onPress={() =>
                    setCurrentMonthStr(
                      currentMonth.subtract(1, "month").format("YYYY-MM-DD"),
                    )
                  }
                  style={{
                    padding: 8,
                ...
                <Pressable
                  onPress={() =>
                    setCurrentMonthStr(
                      currentMonth.add(1, "month").format("YYYY-MM-DD"),
                    )
                  }
                  style={{
                    padding: 8,
        ...
        <View style={{ paddingHorizontal: 20 }}>
          ...
          >
            <View>
              ...
              >
                Ngày {selectedDate.format("DD")} tháng{" "}
            ...
            >
              <Text
                style={{ fontSize: 11, fontFamily: "SpaceGrotesk_700Bold" }}
              >
                {!dailyReminders || dailyReminders.length === 0
                  ? "TRỐNG"
                  : `${dailyReminders.length} CỬ UỐNG`}
              </Text>
            </View>
          </View>
      ...
      >
        ...
        >
          <View style={{ flex: 1 }}>
            ...
            >
              Lúc {timeInfo.display} -{" "}
              {dayjs(selectedDateStr).format("DD/MM/YYYY")}
            </Text>
            <Text
              style={{
                fontSize: 19,
          ...
          <View
            style={{
              backgroundColor: isTaken ? "#A3E6A1" : "transparent",
              paddingHorizontal: 10,
              paddingVertical: 4,
              borderRadius: 10,
              borderWidth: 1.5,
              borderColor: isTaken ? "transparent" : "rgba(0,0,0,0.1)",
            }}
          >
            <Text
              style={{
