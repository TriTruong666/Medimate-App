...
export default function PrescriptionIndexScreen() {
    ...
    const handleSelectMethod = (method: 'scan' | 'upload' | 'manual') => {
        popup.open({
        ...
        <SafeAreaView className="flex-1 bg-[#F9F6FC]" edges={["top"]}>
            ...
            >
                ...
                <View className="gap-y-4">
                    ...
                    <Pressable onPress={() => handleSelectMethod('manual')} className="bg-white border-[3px] border-dashed border-gray-300 rounded-[28px] p-5 active:opacity-80">
