            ...
            <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} className="flex-1">
                <ScrollView contentContainerStyle={{ padding: 24, paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
                    ...
                    <View className="items-center mb-10">
                        ...
                        <Text className="text-3xl font-space-bold text-black text-center mb-2">Xác thực OTP</Text>
                    ...
                    <View className="items-center relative">
                        <Text className="text-xs font-space-bold mb-4 uppercase text-center text-gray-500">Nhập mã 6 chữ số</Text>
                        ...
                        >
                            {Array(CODE_LENGTH).fill(0).map((_, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        <Text className="text-2xl font-space-bold text-black">{digit}</Text>
                                    </View>
                                );
                            })}
                        </Pressable>
                    ...
                    >
                        {isPending ? (
                            ...
                            <Text className="text-center font-space-bold text-lg text-black uppercase">Xác nhận ngay</Text>
                        )}
                    </Pressable>
